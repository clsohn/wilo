class Api::V1::UsersController < ApplicationController
  ...
  def create
    ...
    if user.update(phone_number: fetch_params['phoneNumber'], commute_one_start: fetch_params['commuteOneStart'],
      commute_one_end: fetch_params['commuteOneEnd'], commute_two_start: fetch_params['commuteTwoStart'],
